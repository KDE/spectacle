    ...
    , m_delaySpinBox(new SmartSpinBox(m_delayWidget.get()))
{
    ...
    auto includeMousePointerAction = addAction(i18nc("@option:check", "Include mouse pointer"));
    ...
    spinbox->setSpecialValueText(i18nc("@item", "No Delay"));
    ...
    auto videoIncludeMousePointerAction = addAction(i18nc("@option:check", "Include mouse pointer"));
